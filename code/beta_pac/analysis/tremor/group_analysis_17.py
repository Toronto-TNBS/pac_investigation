...
def main2():
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/17/stats_b_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/17/stats_nb_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/17/stats_s_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("non structured", "../../../../results/tremor/stats/17/stats_ns_" + targets[data_idx] + ".npy", np.asarray(tmp))
