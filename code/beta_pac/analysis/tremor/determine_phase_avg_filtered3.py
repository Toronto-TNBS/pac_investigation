...
(data1, data2, data3, loc_burst_fit)    = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "tremor", "hf tremor",
                                               axes[0, :], axes2[0, :], dir_type, dir_thresh)
(data4, data5, data6, _)                = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "tremor", "hf non tremor",
                                               axes[1, :], axes2[1, :], dir_type, dir_thresh, loc_burst_fit)

dir_type = 1
dir_thresh = 0.0
(data7, data8, data9, _)                = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "tremor", "hf tremor",
                                               axes3[0, :], axes4[0, :], dir_type, dir_thresh, loc_burst_fit)
(data10, data11, data12, _)             = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "tremor", "hf non tremor",
