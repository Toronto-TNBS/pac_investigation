...
def main():
    ...
    formulas = ["target_value ~ burst + (1|patient_id) + (1|trial)", 
                "target_value ~ lf + (1|patient_id) + (1|trial)", 
                "target_value ~ hf + (1|patient_id) + (1|trial)", 
                "target_value ~ pac + (1|patient_id) + (1|trial)", 
                "target_value ~ burst + lf + hf + pac + burst:lf + burst:hf + burst:pac + (1|patient_id) + (1|trial)", 
                "target_value ~ burst + hf + burst:hf + (1|patient_id) + (1|trial)", 
                "target_value ~ burst + hf + (1|patient_id) + (1|trial)"]
