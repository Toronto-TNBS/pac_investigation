...
def main1():
    ...
    tremor_burst_strength_idx = pre_labels.index("pac burst specific strength norm 5")
    tremor_non_burst_strength_idx = pre_labels.index("pac non burst specific strength norm 5")
    tremor_random_burst_strength_idx = pre_labels.index("pac random burst specific strength norm 5")
    tremor_random_non_burst_strength_idx = pre_labels.index("pac random non burst specific strength norm 5")
    ...
    for idx_list_idx in range(len(idx_lists_burst)):
        ...
        for row_idx in range(len(pre_data)):
            ...
            if (pre_data[row_idx, idx_lists_burst[idx_list_idx]][0] == ""):
                continue
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/17/stats_" + targets[data_idx] + ".npy", np.asarray(tmp))
...
def main2():
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/177/stats_b_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/177/stats_nb_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/177/stats_s_" + targets[data_idx] + ".npy", np.asarray(tmp))
    ...
    for data_idx in range(len(data)):
        ...
        np.save("non structured", "../../../../results/tremor/stats/177/stats_ns_" + targets[data_idx] + ".npy", np.asarray(tmp))
