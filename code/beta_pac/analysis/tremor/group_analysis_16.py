...
def main():
    ...
    tremor_burst_strength_idx = pre_labels.index("pac burst specificity 3")
    tremor_non_burst_strength_idx = pre_labels.index("pac non burst specificity 3")
    ...
    for data_idx in range(len(data)):
        ...
        np.save("../../../../results/tremor/stats/16/stats_" + targets[data_idx] + ".npy", np.asarray(tmp))
