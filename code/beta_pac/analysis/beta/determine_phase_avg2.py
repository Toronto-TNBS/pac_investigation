...
(data1, data2, loc_burst_fit)   = main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf beta", axes[0, :])
(data3, data4, _)               = main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf non beta", axes[1, :], loc_burst_fit)
