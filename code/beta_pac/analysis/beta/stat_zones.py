...
def main2():
    ...
    for data_idx in range(len(data)):
        ...
        feat_idx = 0; print(float(stats[2, 0])*1, "%3.3f" % (float(stats[2, 0])*7,), "%05.03f, %05.03f, %05.03f" % ((float(stats[3, feat_idx]) + float(stats[3, -1]))/float(stats[3, -1]), (float(stats[3, feat_idx]) - float(stats[4, feat_idx]) + float(stats[3, -1]))/float(stats[3, -1]), (float(stats[3, feat_idx]) + float(stats[4, feat_idx]) + float(stats[3, -1]))/float(stats[3, -1])))
