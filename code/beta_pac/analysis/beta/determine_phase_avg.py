...
def main(path, subpath, mode, type):
    ...
    print(loc_data1.shape, loc_data2.shape)
...
main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf beta")
main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf non beta")
plt.show(block = True)
