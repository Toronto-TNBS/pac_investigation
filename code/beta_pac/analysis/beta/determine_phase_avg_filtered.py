...
def main(path, subpath, mode, beta_type, axes, axes2, dir_type, dir_thresh):
    (values, data, fit, patients, trials, dirs, f_names) = get_values(path, subpath, mode, beta_type)
    print(values.shape)
...
(data1, data2) = main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf beta", axes[0, :], axes2[0, :], dir_type, dir_thresh)
(data3, data4) = main("/mnt/data/Professional/UHN/pac_investigation/results/", "/data/2/", "beta", "hf non beta", axes[1, :], axes2[1, :], dir_type, dir_thresh)
