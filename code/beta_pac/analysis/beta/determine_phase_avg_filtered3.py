...
def main(path, subpath, mode, beta_type, axes, axes2, dir_type, dir_thresh, ideal_ref_slope = None):
    ...
    #filter data
    hfo_dirs = np.asarray(np.copy(dirs[:, 0]), dtype = float)
    hfo_dirs_idx_1 = np.argwhere(np.abs(np.asarray(hfo_dirs, dtype = float)) > dir_thresh).squeeze()
    hfo_dirs_idx_2 = np.argwhere(np.sign(hfo_dirs[hfo_dirs_idx_1]) == dir_type).squeeze()
    hfo_dirs_idx = hfo_dirs_idx_1[hfo_dirs_idx_2]
    
    burst_dirs = np.asarray(np.copy(dirs[:, 1]), dtype = float)
    ...
    non_burst_dirs = np.asarray(np.copy(dirs[:, 1]), dtype = float)
    ...
    #loc_burst_data1 = loc_burst_data1[hfo_dirs_idx, :]; patients1 = patients1[hfo_dirs_idx]; trials1 = trials1[hfo_dirs_idx]; loc_burst_fit1 = loc_burst_fit1[hfo_dirs_idx, :]; f_names1 = f_names1[hfo_dirs_idx]
    ...
    #loc_non_burst_data1 = loc_non_burst_data1[hfo_dirs_idx, :]; patients3 = patients3[hfo_dirs_idx]; trials3 = trials3[hfo_dirs_idx]; loc_non_burst_fit1 = loc_non_burst_fit1[hfo_dirs_idx, :]; f_names3 = f_names3[hfo_dirs_idx]
    ...
    #===========================================================================
    # for x in range(loc_burst_data1.shape[0]):
    #     axes[0].plot(loc_burst_data1[x, :], color = "red", label = "avg. burst", zorder = 4, alpha = 0.25)
    #===========================================================================
    ...
    #===========================================================================
    # for x in range(loc_burst_data2.shape[0]):
    #     axes[1].plot(loc_burst_data1[x, :], color = "red", label = "avg. burst", zorder = 4, alpha = 0.25)
    #===========================================================================
    ...
    #     axes[2].plot(loc_non_burst_data1[x, :], color = "red", label = "avg. burst", zorder = 4, alpha = 0.25)
    #===========================================================================
    ...
    #     axes[3].plot(loc_non_burst_data2[x, :], color = "red", label = "avg. burst", zorder = 4, alpha = 0.25)
    #===========================================================================
    ...
    axes2[0].set_title("%i" % (loc_burst_data1.shape[0],))
    axes2[1].set_title("%i" % (loc_burst_data2.shape[0],))
    axes2[2].set_title("%i" % (loc_non_burst_fit1.shape[0],))
    axes2[3].set_title("%i" % (loc_non_burst_fit2.shape[0],))
...
stat_data_114 = np.concatenate((np.concatenate((data1, np.zeros((data1.shape[0], 1))), axis = 1), np.concatenate((data14, np.ones((data14.shape[0], 1))), axis = 1)), axis = 0)
stat_data_116 = np.concatenate((np.concatenate((data1, np.zeros((data1.shape[0], 1))), axis = 1), np.concatenate((data16, np.ones((data16.shape[0], 1))), axis = 1)), axis = 0)
...
plt.figure()
plt.errorbar(np.arange(0, len(full_stat_data)), np.asarray(vals)[:, 0], yerr = np.asarray(vals)[:, 1])
plt.bar(np.arange(0, len(full_stat_data)), np.asarray(vals)[:, 0])
