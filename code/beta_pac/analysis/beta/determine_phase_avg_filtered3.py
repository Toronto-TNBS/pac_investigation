...
(data1, data2, data3, data4, loc_burst_fit, 
 hist1, hist2, hist3, hist4)                   = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "beta", "hf beta",
                                                      axes[0, :], axes2[0, :], dir_type, dir_thresh)
(data5, data6, data7, data8, _, 
 hist5, hist6, hist7, hist8)                   = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "beta", "hf non beta",
                                                      axes[1, :], axes2[1, :], dir_type, dir_thresh, loc_burst_fit)

dir_type = -1
dir_thresh = 0.1
(data9, data10, data11, data12, _, 
 hist9, hist10, hist11, hist12)                 = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "beta", "hf beta",
                                                         axes3[0, :], axes4[0, :], dir_type, dir_thresh, loc_burst_fit)

(data13, data14, data15, data16, _, 
 hist13, hist14, hist15, hist16)                = main("/mnt/data/Professional/UHN/projects/old/pac_investigation/results/", "/data/2/", "beta", "hf non beta",
